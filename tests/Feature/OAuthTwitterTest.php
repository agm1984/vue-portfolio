...
class OAuthTwitterTest extends TestCase
{
    ...
    public function it_can_create_new_user_from_twitter_identity()
    {
        ...
        $userId = User::query()->firstWhere('email', $twitter_identity['email'])->id;
        ...
        $providerCount = OAuthProvider::query()->where('user_id', $userId)->where('provider', 'twitter')->count();
    ...
    public function it_can_update_twitter_identity_for_existing_user()
    {
        ...
        $providerCount = OAuthProvider::query()->where('user_id', $existing_user->id)->where('provider', 'twitter')->count();
