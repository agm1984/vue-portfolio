    ...
    <div class="flex-1 w-full flex flex-col transition-colors duration-300">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700 p-8 transition-colors duration-300">
            <div class="flex justify-between items-center">
                <h3 class="text-gray-900 dark:text-white">Elevation & Depth</h3>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 mt-8 items-center">
                <div class="lg:col-span-7 flex justify-center py-12 bg-gray-50 dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-700 overflow-hidden relative transition-colors">
                    ...
                    <div
                        class="w-64 h-40 bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 flex items-center justify-center transition-all duration-500 ease-out"
                        :class="currentShadow"
                    >
                        <div class="text-center">
                            <i class="pi pi-box text-indigo-500 mb-2" style="font-size: 32px;"></i>
                            <p class="font-bold text-gray-900 dark:text-white transition-colors">Card Surface</p>
                        </div>
                    </div>
                </div>
        ...
        <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 mt-8">
            ...
            >
                <div
                    class="h-24 bg-white dark:bg-gray-800 rounded-xl border border-gray-100 dark:border-gray-700 flex items-center justify-center transition-all group-hover:-translate-y-1"
                    :class="shadow.class"
                >
                    <span class="text-xs font-mono text-gray-400 group-hover:text-indigo-500 transition-colors">{{ shadow.class }}</span>
                </div>
                <div class="text-center">
                    <p class="text-sm font-bold text-gray-700 dark:text-gray-300 transition-colors">{{ shadow.name }}</p>
                    <p class="text-[10px] text-gray-500 dark:text-gray-400 leading-tight mt-1">{{ shadow.use }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-8">
            ...
            <Card class="p-0 overflow-hidden border-0 shadow-lg dark:shadow-none dark:border dark:border-gray-700 bg-white dark:bg-gray-800">
                ...
                <template #content>
                    <div class="p-6 text-sm text-gray-600 dark:text-gray-300 space-y-2 transition-colors">
                ...
                <template #footer>
                    <div class="bg-gray-50 dark:bg-gray-900/50 px-6 py-3 border-t border-gray-100 dark:border-gray-700 flex justify-between items-center transition-colors">
            ...
            <div class="group relative bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 p-6 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 cursor-pointer">
                <div class="absolute top-4 right-4 text-gray-300 dark:text-gray-600 group-hover:text-indigo-500 transition-colors">
