...
<template>
    <a-page>
        ...
        >
            <template #description>
                <p class="text-gray-600 dark:text-gray-400">
                    The system uses <a href="https://fonts.google.com/specimen/Lato" target="_blank" class="text-indigo-500 dark:text-indigo-400 hover:underline font-bold">Lato</a> as the primary typeface for optimal readability and modern aesthetics.
                </p>
            </template>
        </a-page-title>
        ...
        <a-card class="p-8 mt-8 relative overflow-hidden">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center relative z-10">
                <div>
                    <p class="text-7xl font-aroly text-indigo-600 dark:text-indigo-400 leading-none tracking-wide mt-4">
                        Aa
                    </p>
                    <p class="text-4xl font-aroly mt-4 text-gray-800 dark:text-white">
                        {{ previewText }}
                    </p>
                </div>
                <div class="">
                    ...
                    <div
                        class="mt-4 inline-flex items-center gap-2 px-3 py-2 bg-gray-100 dark:bg-gray-700 rounded cursor-pointer hover:bg-gray-200 dark:hover:bg-gray-600"
            ...
            <div class="absolute -right-10 -bottom-20 text-[12rem] font-aroly text-gray-200 dark:text-gray-600 pointer-events-none opacity-50 dark:opacity-20 select-none">
                Aa
            </div>
        </a-card>
            ...
            <div class="mt-4">
                <div class="space-y-8">
                    <div
                        ...
                        :key="`heading-${index}`"
                        class="group grid grid-cols-1 md:grid-cols-12 gap-4 items-baseline border-b border-gray-300 dark:border-gray-700 last:border-0 pb-6 last:pb-0"
                    >
                        ...
                        <div class="md:col-span-4 flex flex-col items-start md:items-end gap-1">
                            <h3 class="text-indigo-500! dark:text-indigo-400!">{{ item.label }}</h3>
                ...
                <div>
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
                        <div
                            ...
                            :key="weight.name"
                            class="flex flex-col gap-2 p-4 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 cursor-pointer group"
                            @click="copyClass(weight.class)"
                        >
                            <div class="text-4xl text-gray-900 dark:text-white" :class="weight.class">Aa</div>
                            <div class="mt-auto">
                                <div class="font-bold text-sm text-gray-700 dark:text-gray-300 group-hover:text-indigo-600 dark:group-hover:text-indigo-400">{{ weight.name }}</div>
