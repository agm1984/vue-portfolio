        ...
        <a-card class="p-8">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
                <div class="prose dark:prose-invert text-gray-600 dark:text-gray-300">
                    ...
                    <ul class="mt-4 space-y-1 text-sm font-mono bg-gray-50 dark:bg-gray-900 p-4 rounded-lg border border-gray-200 dark:border-gray-700">
                ...
                <div class="relative flex items-center justify-center bg-gray-50 dark:bg-gray-900 rounded-xl border border-dashed border-gray-300 dark:border-gray-700 p-8">
        ...
        <a-card class="p-8 mt-8">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
                ...
                >
                    ...
                    <code class="mt-2 text-xs text-gray-500 dark:text-gray-400">p-{{ size.step }}</code>
                </div>
            </div>
        </a-card>
    </a-page>
