...
<template>
    <div class="flex-1 w-full max-w-4xl mx-auto flex flex-col p-8 leading-relaxed text-gray-800 dark:text-gray-300">
        <h1 class="text-gray-900 dark:text-white">Terms of Use</h1>

        <p class="text-gray-600 dark:text-gray-400 mt-2">LAST UPDATE OF THIS TERMS OF USE - November 23, 2025</p>

        <p class="mt-6">
            Adam Mackintosh's Portfolio (together with its affiliates and subsidiaries, "we", "us", "our" and terms of similar meaning) provides this Website (this site and any software provided by the Company for use with the site, the "Site") to you subject to these terms of use (these "Terms"). In these terms we describe users ("Users") of the Site as both registered and unregistered users.
        </p>
        ...
        <h3 class="mt-4 text-gray-900 dark:text-white">User Accounts & Responsibilities</h3>
        ...
        <h3 class="mt-4 text-gray-900 dark:text-white">Content & Intellectual Property</h3>
        ...
        <h3 class="mt-4 text-gray-900 dark:text-white">License & Restrictions</h3>
        ...
        <h3 class="mt-4 text-gray-900 dark:text-white">Third-Party Content</h3>
        ...
        <h3 class="mt-4 text-gray-900 dark:text-white">Disclaimers & Indemnification</h3>
