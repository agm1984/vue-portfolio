...
<script>
// source: https://canada.findforms.com/single_example.php/example/51/Canadian_Terms_of_Use_for_Website
export default {
    name: 'terms-of-use',
