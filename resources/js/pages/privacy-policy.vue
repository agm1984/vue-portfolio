...
<template>
    <div class="flex-1 w-full max-w-4xl mx-auto flex flex-col p-8 leading-relaxed text-gray-800 dark:text-gray-300">
        ...
        <h3 class="mt-4">COLLECTION OF PERSONAL INFORMATION</h3>
        ...
        <h3 class="mt-4">HOW DOES COMPANY USE INFORMATION GATHERED ABOUT ONLINE VISITORS?</h3>
        ...
        <h3 class="mt-4">PROMOTIONAL AND INFORMATIONAL OFFERS</h3>
        ...
        <h3 class="mt-4">DISCLOSURE OF INFORMATION</h3>
        ...
        <h3 class="mt-4">PROTECTION OF CHILDREN ONLINE</h3>
        ...
        <h3 class="mt-4">ADDITIONAL TERMS FOR CERTAIN WEBSITES</h3>
        ...
        <h3 class="mt-4">PROTECTION OF INFORMATION</h3>

        <h4 class="mt-2">Our Commitment to Security:</h4>
        ...
        <h4 class="mt-2">Storage of Information:</h4>
        ...
        <h3 class="mt-4">POLICY CHANGE</h3>
        ...
        <h3 class="mt-4">ACCEPTANCE OF OUR PRIVACY POLICY</h3>
