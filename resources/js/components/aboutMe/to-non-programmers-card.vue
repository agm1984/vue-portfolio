...
<template>
    <div class="h-full bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 border-t-4 border-t-emerald-500 p-8 rounded-xl shadow-sm">
        <h2 class="text-2xl font-bold text-emerald-700 dark:text-emerald-400 mb-4">
            To Non-Programmers
        </h2>
        ...
        <div class="w-full mt-4">
            <Accordion :value="[]" multiple class="space-y-2">
                <AccordionPanel value="0">
                    <AccordionHeader>
                        <span class="font-semibold text-gray-700 dark:text-gray-200">Work</span>
                    </AccordionHeader>
                    <AccordionContent>
                ...
                <AccordionPanel value="1">
                    <AccordionHeader>
                        <span class="font-semibold text-gray-700 dark:text-gray-200">Life</span>
                    </AccordionHeader>
                    <AccordionContent>
                        <p class="leading-relaxed text-gray-600 dark:text-gray-300">
                            ...
                            <span class="italic text-emerald-600 dark:text-emerald-400 font-medium">salty, sweet, sour, and hot</span>.
                        </p>
                    </AccordionContent>
                </AccordionPanel>
                ...
                <AccordionPanel value="2">
                    <AccordionHeader>
                        <span class="font-semibold text-gray-700 dark:text-gray-200">Balance</span>
                    </AccordionHeader>
                    <AccordionContent>
                        <p class="leading-relaxed text-gray-600 dark:text-gray-300">
