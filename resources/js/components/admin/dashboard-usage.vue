    ...
    <a-card class="flex flex-col justify-between p-8">
        <div class="mb-8">
            <div class="flex items-center justify-between text-sm mb-2">
                <h6>Memory (RAM)</h6>
                <span class="font-mono font-semibold text-indigo-600 dark:text-indigo-400">{{ formattedMemory }}</span>
            </div>
            ...
            />
            <p class="text-xs text-gray-500 dark:text-gray-400 mt-2 text-right">512MB Limit</p>
        </div>
        ...
        <div>
            ...
            <p class="text-xs text-gray-500 dark:text-gray-400 mt-2 text-right">InnoDB Engine</p>
        </div>
    </a-card>
</template>
