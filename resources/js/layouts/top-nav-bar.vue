<template>
    <div class="Nav" role="navigation">
        <div class="flex items-center w-192 flex-0">
            <router-link to="/" class="flex items-center" title="View home" role="banner">
        ...
        <div class="flex items-center justify-center flex-1">
            <router-link to="/about" class="nav-link-white">About me</router-link>
        ...
        <div class="flex items-center w-192 flex-0">
            <b-dropdown v-if="isAuthenticated" aria-role="menu">
                ...
                <b-dropdown-item aria-role="listitem" has-link>
                    <router-link to="/design">Design system</router-link>
                </b-dropdown-item>
...
export default {
    ...
    computed: {
        isAuthenticated() {
            console.log('isAuthenticated', this.$store.getters['auth/check']);
